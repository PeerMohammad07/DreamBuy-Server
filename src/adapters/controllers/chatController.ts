...
export default class chatController implements IChatController {
  ...
  async getConversations(req: Request<ParamsDictionary, any, any, ParsedQs, Record<string, any>>,
  ...
  async sendMessage(req: Request<ParamsDictionary, any, any, ParsedQs, Record<string, any>>,
    res: Response<any, Record<string, any>>){
    try {
  ...
  async getMessage(req: Request<ParamsDictionary, any, any, ParsedQs, Record<string, any>>,
    res: Response<any, Record<string, any>>){
